...
<div id="new-parameter-provider-dialog" layout="column" class="hidden">
    <img src="images/?70.png" style="width: 28px;height: 28px;margin: -1px 0px 0px -6px;cursor: pointer;position: absolute;right: 10px;top: 10px" onclick="$('#new-parameter-provider-dialog').hide()">
